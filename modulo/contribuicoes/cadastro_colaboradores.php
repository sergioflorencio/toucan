	...
	<div class="uk-grid" style="padding-left: 10px;">
		...
		<?php 
			if(isset($_GET['pesquisa'])){
				$tabelas=new tabelas;$tabelas->listar_colaboradores($_GET['pesquisa']);
			} 

			if(isset($_GET['id'])){
				
				if($_GET['id']=="novo"){$cod_colaborador="";}else{$cod_colaborador=$_GET['id'];}
				
				$cadastros=new cadastros;
				$cadastros->cad_colaboradores($cod_colaborador);
			}
		?>
