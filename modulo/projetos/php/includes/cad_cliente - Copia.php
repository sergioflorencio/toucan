				...
				<div class="uk-form-row uk-width-1-4">
					<div class="uk-grid">
						<div class="uk-width-1-2">
							<?php 
								$inputs->input_form_row($cod_cliente,'cod_cliente','cod_cliente','',' readonly');
							?>
						</div>
					</div>
				</div>
				<div class="uk-form-row">
					<div class="uk-grid">	
						<div class="uk-width-3-4">
							<?php 
								$inputs->input_form_row($razao_social,'razao_social','razao_social','','');
							?>
						</div>
						<div class="uk-width-1-4">
							<?php 
								$inputs->input_form_row($cnpj,'cnpj','cnpj','','');
							?>
						</div>
					</div>
				</div>
