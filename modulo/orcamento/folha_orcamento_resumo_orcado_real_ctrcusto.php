<?php
	...
	$filtros= new filtros;
	$filtros->filtro_orcado_real_ctrcusto($id_orcamento,$schema_real);
	
	
	//relatório
	if(isset($_POST['id_orcamento']) and isset($_POST['schema_real'])){
		if(isset($_POST['idconta']) and $_POST['idconta']!=""){
		...
		$tabelas=new tabelas;
		echo "<script>";
				$tabelas->orcamento_orcado_real_ctrcusto($_POST['schema_real'],$_POST['id_orcamento'],$idconta);
		echo "</script>";
